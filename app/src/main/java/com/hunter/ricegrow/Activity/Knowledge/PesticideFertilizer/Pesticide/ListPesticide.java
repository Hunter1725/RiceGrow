...
public class ListPesticide extends AppCompatActivity {
    ...
    private PesticideAdapter pesticideAdapter, pesticideAdapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_pesticide);
...
//                finish();
        ...
        //Initialize adapter
        pesticideAdapter = new PesticideAdapter(this);
        ...
        //Search view
        pesticideAdapter2 = new PesticideAdapter(this);
