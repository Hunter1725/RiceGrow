package com.hunter.ricegrow.Activity.Knowledge.StageActivity.Activity;
...
public class ListActivity extends AppCompatActivity {
    ...
    private RecyclerView activityRecView, resultRecView;
    private SearchBar search_bar;
    private SearchView search_view;
    private ActivityAdapter activityAdapter, activityAdapter2;
    private RiceGrowDatabase db;
    private ArrayList<Activities> activities = new ArrayList<>();
    private ArrayList<Activities> activities2 = new ArrayList<>();
...
//                finish();
        ...
        activityRecView.setLayoutManager(new LinearLayoutManager(this));
        activities = (ArrayList<Activities>) db.activityDao().getAllActivities();
        activityAdapter.setActivities(activities);

        //Search view
        activityAdapter2 = new ActivityAdapter(this);
        resultRecView.setAdapter(activityAdapter2);
        ...
        search_view.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                activities2 = (ArrayList<Activities>) db.activityDao().getActivitiesByName(name);
                if(activities2.size()!=0){
                    resultRecView.setVisibility(View.VISIBLE);
                    activityAdapter2.setActivities(activities2);
