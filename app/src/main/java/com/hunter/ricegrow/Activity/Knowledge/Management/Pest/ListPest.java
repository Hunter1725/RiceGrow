...
public class ListPest extends AppCompatActivity {

    private NestedScrollView nestedScrollView;
    private FloatingActionButton fabScrollToTop;
    private TextView txtEmpty;
    private RecyclerView pestRecView, resultRecView;
    private SearchBar search_bar;
    private SearchView search_view;
    private PestAdapter pestAdapter, pestAdapter2;
    private RiceGrowDatabase db;
    private ArrayList<Pests> pests = new ArrayList<>();
    private ArrayList<Pests> pests2 = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        WindowCompat.setDecorFitsSystemWindows(getWindow(), false);
        setContentView(R.layout.activity_list_pest);
...
//                finish();
        ...
        //Initialize adapter
        pestAdapter = new PestAdapter(this);
        pestRecView.setAdapter(pestAdapter);
        pestRecView.setLayoutManager(new LinearLayoutManager(this));
        pests = (ArrayList<Pests>) db.pestDao().getAllPests();
        pestAdapter.setPests(pests);

        //Search view
        pestAdapter2 = new PestAdapter(this);
        resultRecView.setAdapter(pestAdapter2);
        ...
        search_view.getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                pests2 = (ArrayList<Pests>) db.pestDao().getPestsByName(name);
                if(pests2.size()!=0){
                    resultRecView.setVisibility(View.VISIBLE);
                    pestAdapter2.setPests(pests2);
    ...
    private void initView() {
        pestRecView = findViewById(R.id.pestRecView);
