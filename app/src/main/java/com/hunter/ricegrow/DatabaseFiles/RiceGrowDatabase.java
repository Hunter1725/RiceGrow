...
import com.hunter.ricegrow.DatabaseFiles.Dao.ActivityDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.ActivityFertilizerDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.ActivityPesticideDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.CropDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.CropDeftoxDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.CropDiseaseDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.CropPestDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.CropStageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.CropWeedDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.DeficienciesToxicitiesDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.DeftoxFertilizerDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.DeftoxStageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.DiseaseDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.DiseasePesticideDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.DiseaseStageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.FertilizerCalculatingDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.FertilizerDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.MessageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.NoteDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.PestDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.PestPesticideDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.PestStageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.PesticideDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.PlanActivityDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.PlanStageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.SettingDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.StageDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.UserCropDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.WeatherDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.WeedDao;
import com.hunter.ricegrow.DatabaseFiles.Dao.WeedPesticideDao;
...
public abstract class RiceGrowDatabase extends RoomDatabase {
    ...
    private static void populateInitialData() {
        ...
        executor.execute(() -> {
            ...
            Activities activities8 = new Activities(stageDao.getIdByName("Planting"), "Transplanting", "Cấy lúa", "Transplanting is commonly practiced as a method of weed control for wet or puddled fields. It requires less seed but much more labor compared to direct seeding. Also, transplanted crops take longer to mature due to transplanting shock.",
